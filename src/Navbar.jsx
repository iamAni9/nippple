      ...
      <nav className='w-full h-14 sm:grid grid-cols-12 gap-4 hidden'>
        ...
        <div className='col-span-4 flex items-center'>
            <ul className='flex justify-between align-middle gap-8 font-mono'>
                <li><Link to="/" className="hover:border-b-2">DesignI</Link></li>
                <li><Link to="/DesignTwo" className="hover:border-b-2">DesignII</Link></li>
                <li><Link to="/DesignThree" className="hover:border-b-2">DesignIII</Link></li>
                <li><Link to="/" className="hover:border-b-2">DesignIV</Link></li>
            </ul>
        </div>
      ...
      <nav className='w-full h-14 grid grid-cols-12 gap-2 sm:hidden'>
        ...
        <div className={`w-full ${menuOpen ? 'max-h-full' : 'max-h-0'} overflow-hidden transition-max-height duration-300`}>
            <div className={`flex flex-col items-center pt-2 pb-2 bg-gray-200 ${menuOpen ? 'opacity-100' : 'opacity-0'}`} style={{ transition: 'opacity 0.3s' }}>
                <Link to="/" className="hover:border-b-2 hover:border-black mb-2">DesignI</Link>
                <Link to="/DesignTwo" className="hover:border-b-2 hover:border-black mb-2">DesignII</Link>
                <Link to="/DesignThree" className="hover:border-b-2 hover:border-black mb-2">DesignIII</Link>
                <Link to="/" className="hover:border-b-2 hover:border-black mb-2">DesignIV</Link>
            </div>
        </div>
      </>
  )
